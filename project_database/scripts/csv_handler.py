...
# Load data
df = pd.read_csv('project_database/data/cleaned_file.csv',delimiter=';')
...
df.to_csv('project_database/data/aa_output.csv', sep=';', index=False, quoting=csv.QUOTE_MINIMAL)
